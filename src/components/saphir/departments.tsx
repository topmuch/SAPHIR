...
export function Departments() {
  return (
    <section
      id="departements"
      className="bg-slate-50/80 dark:bg-sapphire py-20 md:py-28 w-full"
    >
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {DEPARTMENTS.map((dept) => (
            <StaggerItem key={dept.name}>
              <div className="bg-white/70 dark:bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden group hover:shadow-xl hover:shadow-sapphire/10 border border-slate-200/50 dark:border-white/10 hover:border-gold/30 transition-all duration-300">
                ...
                <div className="p-6 text-center">
                  <h3 className="font-semibold text-sapphire dark:text-white text-lg">
                    {dept.name}
                  </h3>
                </div>
              </div>
